...
import ru.linachan.monitor.db.MonitorDataBase;
...
public class BuildMonitorPlugin implements YggdrasilPlugin {

    private MonitorDataBase dbClient;
    ...
    public MonitorDataBase getDbClient() {
        return dbClient;
    }
